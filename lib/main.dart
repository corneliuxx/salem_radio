...
import 'Helper/HexColorSupport.dart';
...
// initialise the plugin. app_icon needs to be a added as a drawable resource to the Android head project
  ...
  AppBar getAppbar() {
    return AppBar(
      title: appBarTitle,
      iconTheme: IconThemeData(color: apptextcolor),
              ...
              if (iconSearch.icon == Icons.search) {
                ...
                appBarTitle = TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText: 'Search...',
                    hintStyle: TextStyle(color: apptextcolor2),
                  ),
      ...
      child: Container(
          ...
          child: ListView(
            ...
            children: <Widget>[
              ...
              ListTile(
                  leading: Icon(Icons.radio, color: apptextcolor),
                  title: Text(
                    'Radio',
                    style: TextStyle(color: apptextcolor),
                  ),
              ...
              ListTile(
                  leading: Icon(Icons.security, color: apptextcolor),
                  title: Text(
                    'Privacy Policy',
                    style: TextStyle(color: apptextcolor),
                  ),
              ...
              ListTile(
                  leading: Icon(Icons.warning, color: apptextcolor),
                  title: Text(
                    'Terms & Conditions',
                    style: TextStyle(color: apptextcolor),
                  ),
